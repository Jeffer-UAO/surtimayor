    ...
    <div className={styles.container}>
      ...
      <div className={styles.vision}>
        ...
        <p>
          ...
          tecnológicamente avanzada, adaptándonos constantemente a las
          necesidades y deseos de nuestros clientes y ofreciendo soluciones
          eficientes y efectivas. Queremos ser una empresa sostenible y
          responsable, contribuyendo al desarrollo económico y social del país y
          minimizando nuestro impacto ambiental. Nuestra visión es convertirnos
          en la opción preferida de compra para nuestros clientes,
          ofreciendo un servicio excepcional y una experiencia de compra
          satisfactoria en todo momento. Estamos comprometidos a crecer y
          expandirnos, tanto en alcance como en variedad de productos y
          servicios, para ofrecer siempre lo mejor a nuestros clientes.
        </p>
      </div>
